...
```
bash <(curl -s https://raw.githubusercontent.com/hermagulator/wizwizxui-timebot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/hermagulator/wizwizxui-timebot/main/update.sh)
```
