...
function getGateWaysKeys() {
    ...
    $buttons[] = [
        ['text' => $botState['tronWallet'] == "on" ? $buttonValues['on'] : $buttonValues['off'], 'callback_data' => "changeGateWays_tronWallet"],
...
function handlePerfectMoneyPaymentforservice($hash_id, $voucherCode, $activationCode) {
    global $connection, $mainValues, $userInfo, $admin;
